...
class flujograma(gr.top_block):
    def __init__(self):
        ...
        self.src2 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, f/2., 1.2, 0)
        self.nse = analog.noise_source_f(analog.GR_GAUSSIAN, 0.1)
        self.add = misbloques.e_add_ff(1/3.)
        ...
        # Las conexiones
        # self.connect(la salida, a entrada)
        self.connect(self.src, (self.add, 0))
        self.connect(self.nse, (self.add, 1))
        self.connect(self.src2, (self.add, 2))
