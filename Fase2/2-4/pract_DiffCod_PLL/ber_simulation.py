...
# Generated: Fri Mar 13 11:49:21 2020
##################################################
...
class ber_simulation(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.uhd_usrp_source_0.set_samp_rate(samp_rate_to_usrp)
        self.uhd_usrp_source_0.set_center_freq(50e6, 0)
        ...
        self.uhd_usrp_sink_0.set_samp_rate(samp_rate_to_usrp)
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/uis-e3t/Documentos/COMU_B1A_G6/B1A.G6_LAB_COMU2/Fase2/2-4/set-fire-to-the-rain.wav', True)
        ...
        [self.menu_grid_layout_2.setRowStretch(r,1) for r in range(2,3)]
        [self.menu_grid_layout_2.setColumnStretch(c,1) for c in range(0,1)]
    ...
    def set_samp_rate_to_usrp(self, samp_rate_to_usrp):
        ...
        self.uhd_usrp_source_0.set_samp_rate(self.samp_rate_to_usrp)
        self.uhd_usrp_sink_0.set_samp_rate(self.samp_rate_to_usrp)
